<template>
    <div class="public-main">
        <div class="public-index-banner">
            <div class="swiper IndexBannerSwiper">
                <div class="swiper-wrapper">
                    <div class="swiper-slide common-banner">
                        <div class="container">
                            <div class="layer-1" style="background: url('static/default/img/banner1.png')"></div>
                            <div class="layer-2">
                                <div class="bt">佳颖网络 - 专业的数字商品交易系统</div>
                                <div class="bt-m">佳颖网络&专业商品交易系统</div>
                                <div class="info mt-4">
                                    <p class="mb-1">免登陆下单、无限分站、货源对接、自定义串货</p>
                                    <p>内置多个系统对接，还可自定义对接，无需软件对接，稳定可靠</p>
                                </div>
                                <div class="info-m">
                                    <p>免登陆下单、无限分站、货源对接、自定义串货</p>
                                </div>
                                <div class="but">
                                    <a href="index/price.html" class="mr-2">立即购买</a>
                                    <a href="#">查看演示</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide common-banner">
                        <div class="container">
                            <div class="layer-1" style="background: url('static/default/img/banner2.png')"></div>
                            <div class="layer-2">
                                <div class="bt">货源无忧 - 自定义对接货源</div>
                                <div class="bt-m">货源无忧&自定义对接货源</div>
                                <div class="info mt-4">
                                    <p class="mb-1">内置多个系统对接，并持续更新，稳定秒级监控，不漏单</p>
                                    <p>可自定义对接，设置简单，便捷快速</p>
                                </div>
                                <div class="info-m">
                                    <p>内置多系统对接，持续更新，稳定监控，不漏单</p>
                                </div>
                                <div class="but">
                                    <a href="index/price.html" class="mr-2">立即购买</a>
                                    <a href="#">查看演示</a>
                    ...
                    <div class="swiper-slide common-banner">
                        <div class="container">
                            <div class="layer-1" style="background: url('static/default/img/banner3.png')"></div>
                            <div class="layer-2">
                                <div class="bt">多级分销 - 金字塔式用户递增，快速引流</div>
                                <div class="bt-m">多级分销&用户递增,快速引流</div>
                                <div class="info mt-4">
                                    <p class="mb-1">分站可单独配置站点信息、上下架商品、利润设置</p>
                                    <p>更加完善的代理加盟体系，无限发展下级分站，摆脱单一的销售模式！</p>
                                </div>
                                <div class="info-m">
                                    <p>分站单独配置站点、上下架商品、利润设置</p>
                                </div>
                                <div class="but">
                                    <a href="index/price.html" class="mr-2">立即购买</a>
                                    <a href="#">查看演示</a>
                ...
                <div class="container banner-pagination">
                    <div class="swiper-pagination"></div>
                </div>
            </div>
            <div class="IndexBannerCard">
                <div class="container">
                    <a class="item" href="#">
                        <div class="fl"></div>
                        <div class="fr">
        ...
        <div class="container">
            <div class="public-index-function">
                <div class="bt">
                    <h2>完善、稳定、货源丰富的数字商品销售系统</h2>
                    <!-- <a href="#" class="mt-4">
                        查看全部功能
                        <i><svg width="12" height="12" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg"
                                class="bt-icon-right">
                                <path
                ...
                <div class="FunctionCard">
                    <div class="col-2 col-xl-3" v-for="(item, index) in body2_list" :key="index">
                        <div class="item">
                            <div class="icon" :style="{ backgroundImage: 'url(' + item.picture[0].url + ')' }"></div>
                            <div class="info">{{ item.title1 }}</div>
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <div class="public-index-privilege">
            <div class="container">
                <div class="bt">
                    <h2>全程售后 享诸多服务</h2>
                    <p>功能长期维护更新 免费售后享无忧</p>
                </div>
                <div class="IndexPrivilegeCard">
                    <div class="left">
                        <div class="item hover">
                            <div class="icon" style="background-image: url('static/default/img/privilegeicon-1.png')"></div>
                            <div class="title">指导</div>
                        </div>
                        <div class="item">
                            <div class="icon" style="background-image: url('static/default/img/privilegeicon-2.png')"></div>
                            <div class="title">更新</div>
                        </div>
                        <div class="item mt-4">
                            <div class="icon" style="background-image: url('static/default/img/privilegeicon-3.png')"></div>
                            <div class="title">会员群</div>
                        </div>
                        <div class="item mt-4">
                            <div class="icon" style="background-image: url('static/default/img/privilegeicon-4.png')"></div>
                            <div class="title">功能</div>
                        </div>
                    </div>
                    <div class="right">
                        <div class="item ing">
                            <div class="title">全程免费指导</div>
                            <div class="info">官方售后免费指导，注册授权，程序搭建，对接上架，网站装修，上线运营！</div>
                            <div class="buts">
                                <a href="index/price.html" target="_blank">查看详情</a>
                                <a href="#" target="_blank">联系我们</a>
                            </div>
                        </div>
                        <div class="item">
                            <div class="title">免费更新</div>
                            <div class="info">一键免费升级更新，解决系统维护难题！</div>
                            <div class="buts">
                                <a href="index/price.html" target="_blank">查看详情</a>
                                <a href="#" target="_blank">联系我们</a>
                            </div>
                        ...
                        <div class="item">
                            <div class="title">官方会员群</div>
                            <div class="info">官方售后技术群，快速上手，免费培训！</div>
                            <div class="buts">
                                <a href="index/price.html" target="_blank">查看详情</a>
                                <a href="#" target="_blank">联系我们</a>
                            </div>
                        ...
                        <div class="item">
                            <div class="title">更多营销功能</div>
                            <div class="info">无限下级、无限分站、分组价格，用户金字塔式快速增长！</div>
                            <div class="buts">
                                <a href="index/price.html" target="_blank">查看详情</a>
                                <a href="#" target="_blank">联系我们</a>
                            </div>
        ...
        <div class="public-index-demo">
            <div class="container">
                <div class="bt">
                    <h2>佳颖网络 - 专业的数字产品销售系统</h2>
                </div>
                <div class="IndexDemo">
                    <div class="left">
                        <div class="item hover">
                            <div class="icon" style="background-image: url('static/default/img/demoicon-1.png')"></div>
                            <div class="title">商城前台</div>
                        </div>
                        <div class="item">
                            <div class="icon" style="background-image: url('static/default/img/demoicon-2.png')"></div>
                            <div class="title">会员中心</div>
                        </div>
                        <div class="item mt-4">
                            <div class="icon" style="background-image: url('static/default/img/demoicon-3.png')"></div>
                            <div class="title">商城后台</div>
                        </div>
                        <div class="item mt-4">
                            <div class="icon" style="background-image: url('static/default/img/demoicon-4.png')"></div>
                            <div class="title">分站演示</div>
                        </div>
                    </div>
                    <div class="right">
                        <div class="img ing"><img src="static/default/img/demo1.png"></div>
                        <div class="img"><img src="static/default/img/demo2.png"></div>
                        <div class="img"><img src="static/default/img/demo3.jpg"></div>
                        <div class="img"><img src="static/default/img/demo4.png"></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="public-footer">
            <div class="container">
                <div class="serve">
                    <div class="item" v-for="(item, index) in body5_list" :key="index">
                        <i :style="{ backgroundImage: 'url(' + item.picture[0].url + ')' }"></i>
                        <div>
                            <em>{{ item.title1 }}</em>
...
export default {
    ...
    mounted() {
        $('.FunctionCard .item').hover(function () {
            $(this).find('.icon').removeClass('icon-leave').addClass('icon-enter');
        }, function () {
            $(this).find('.icon').removeClass('icon-enter').addClass('icon-leave');
        });
        $('.IndexDemo .left .item').hover(function () {
            $(this).find('.icon').removeClass('icon-leave').addClass('icon-enter');
            $(this).siblings().removeClass('hover');
            $(this).addClass('hover');
            $('.IndexDemo .right .img').removeClass('ing').eq($(this).index()).addClass('ing');
        }, function () {
            $(this).find('.icon').removeClass('icon-enter').addClass('icon-leave');
        });
        $('.IndexPrivilegeCard .item').hover(function () {
            $(this).find('.icon').removeClass('icon-leave').addClass('icon-enter');
            $(this).siblings().removeClass('hover');
            $(this).addClass('hover');
            $('.IndexPrivilegeCard .right .item').removeClass('ing').eq($(this).index()).addClass('ing');
        }, function () {
            $(this).find('.icon').removeClass('icon-enter').addClass('icon-leave');
        });
    },
...
.public-header-right-m-nav-btn-icon.user.is-login {
    background: url("../assets/img/icon-user-is.png") no-repeat;
...
.public-index-banner .common-banner {
    background: url("../assets/img/banner-common-bg.png") no-repeat;
...
.public-index-banner .IndexBannerCard .item:nth-child(1) .fl {
    background: url("../assets/img/bannericon1.png") center no-repeat;
    background-size: 100%;
}

.public-index-banner .IndexBannerCard .item:nth-child(2) .fl {
    background: url("../assets/img/bannericon2.png") center no-repeat;
    background-size: 100%;
}

.public-index-banner .IndexBannerCard .item:nth-child(3) .fl {
    background: url("../assets/img/bannericon3.png") center no-repeat;
    background-size: 100%;
}

.public-index-banner .IndexBannerCard .item:nth-child(4) .fl {
    background: url("../assets/img/bannericon4.png") center no-repeat;
    background-size: 100%;
}
...
@media screen and (max-width: 800px) {
    ...
    .public-index-function .FunctionCard .col-2 {
        width: 24% !important;
    }

    .public-index-function .FunctionCard .info {
...
@media screen and (max-width: 800px) {
    ...
    .public-index-privilege .IndexPrivilegeCard .left .mt-4 {
    ...
    .public-index-privilege .IndexPrivilegeCard .right .item:nth-child(1) {
        background: url("../assets/img/privilegecard-1.png") no-repeat 100%;
    }

    .public-index-privilege .IndexPrivilegeCard .right .item:nth-child(2) {
        background: url("../assets/img/privilegecard-2.png") no-repeat 100%;
    }

    .public-index-privilege .IndexPrivilegeCard .right .item:nth-child(3) {
        background: url("../assets/img/privilegecard-3.png") no-repeat 100%;
    }

    .public-index-privilege .IndexPrivilegeCard .right .item:nth-child(4) {
        background: url("../assets/img/privilegecard-4.png") no-repeat 100%;
    }
...
.public-index-please {
    ...
    background-image: url("../assets/img/indexpaybg.png");
    background-repeat: no-repeat;
    background-position: top center;
}
...
.public-price-header {
    ...
    width: 100%;
    padding: 80px 0;
    background: url("../assets/img/price-bg.png") no-repeat;
    background-position: top;
...
.public-price-header-wrap .right .public-price-header-icon {
    width: 66px;
    height: 81px;
    background: url("../assets/img/price-icon-i.png") no-repeat;
    background-size: 100%;
...
.public-price-list-left {
    width: 300px;
    background: url("../assets/img/price-price-bg.jpg") no-repeat;
    background-size: 100%;
}
...
.public-price-list-right .right-content .content .subitem i.yes {
    ...
    width: 15px;
    height: 15px;
    background: url("../assets/img/price-price-yes.png") no-repeat;
    background-size: 100%;
}
...
.public-price-list-right .right-content .content .subitem i.no {
    ...
    width: 15px;
    height: 15px;
    background: url("../assets/img/price-price-no.png") no-repeat;
    background-size: 100%;
}
...
.public-price-content-advantage .item:nth-child(1) .item-wrap .icon {
    background-image: url("../assets/img/price-advantage-icon-1.png");
}

.public-price-content-advantage .item:nth-child(2) .item-wrap .icon {
    background-image: url("../assets/img/price-advantage-icon-2.png");
}

.public-price-content-advantage .item:nth-child(3) .item-wrap .icon {
    background-image: url("../assets/img/price-advantage-icon-3.png");
}

.public-price-content-advantage .item:nth-child(4) .item-wrap .icon {
    background-image: url("../assets/img/price-advantage-icon-4.png");
}
...
.public-price-content-scene-wrap .left .item:nth-child(1) .title i {
    background-image: url("../assets/img/price-scene-icon-1.png");
}

.public-price-content-scene-wrap .left .item:nth-child(2) .title i {
    background-image: url("../assets/img/price-scene-icon-2.png");
}

.public-price-content-scene-wrap .right .title i {
    background-image: url("../assets/img/price-scene-icon-3.png");
}
...
.public-price-content-doc-wrap .wrap {
    ...
    padding: 20px;
    background-color: #fff;
    background-image: url("../assets/img/price-doc-bg.png");
    background-repeat: no-repeat;
